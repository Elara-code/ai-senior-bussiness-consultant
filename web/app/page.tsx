...
export default function Home() {
  ...
  let offline = true;
  const createProject = () => { setCreated(true); setNotice("项目已创建，正在进入项目概览"); window.setTimeout(() => { window.location.href = "/projects/demo"; }, 700); };
  return <div className="page dashboard">
    <header className="masthead"><div><span className="eyebrow">CONSULTING OPERATIONS / 2026</span><h1>项目作战室</h1><p>从客户材料到可审批成果，让每一步专业判断都有证据、有版本、有负责人。</p></div>
      <button className="primary" onClick={createProject}>＋ 新建客户项目</button></header>
